...
const CompleteProfileTeacher = () => {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      const response = await axios.post('https://schoolreadingclubs.vercel.app/api/Teacher/complete-profile-teacher', {
        email: values.email,
        ...
        <Col md={6}>
          <Card className="shadow">
            <Card.Body className="p-4">
              <h2 className="text-center mb-4" style={{ color: '#2c3e50' }}>اكمال الملف الشخصي للمعلم</h2>
...
export default CompleteProfileTeacher;
