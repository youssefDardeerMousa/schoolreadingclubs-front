    ...
    return (
        <div style={{ 
            ...
            <Container>
                ...
                }}>متابعة تقييمات الطلاب</h2>

                <Row className="justify-content-center g-4">
                    <Col xs={12} md={6}>
                        <Card 
                            className="h-100 review-card"
                            onClick={() => navigate('/SchoolsBookClubs/Show_Student_SchoolBookRatings')}
                            style={{
                                borderRadius: '20px',
                                border: 'none',
                        ...
                        >
                            ...
                            <Card.Body className="text-center">
                                ...
                                <div className="mt-3 d-flex align-items-center justify-content-center" style={{ color: '#00b09b' }}>
                    ...
                    <Col xs={12} md={6}>
                        <Card 
                            className="h-100 review-card"
                            onClick={() => navigate('/SchoolsBookClubs/Show_Student_SelfAssessments')}
                            style={{
                                borderRadius: '20px',
                                border: 'none',
                                boxShadow: '0 15px 30px rgba(0,0,0,0.1)',
                        ...
                        >
                            <div style={{
                                ...
                                <p className="mb-0 text-light">متابعة التقييمات الذاتية للطلاب</p>
                            </div>
                            <Card.Body className="text-center">
                                <p style={{ fontSize: '1.1rem', color: '#666' }}>
