...
const LoginSupervisor = () => {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      const { data } = await axios.post('https://schoolreadingclubs.vercel.app/api/Supervisor/loginSupervisor', values);
          ...
          {({ errors, touched, isSubmitting }) => (
            <Form className="login-supervisor-form" dir="rtl">
              ...
              <div className="links-container">
                <span
                  className="link"
                  onClick={() => navigate('/SchoolsBookClubs/ChangeSupervisorPassword')}
                >
                  نسيت كلمة المرور؟
                </span>
              </div>
